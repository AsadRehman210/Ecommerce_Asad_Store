...
const ProductCategory = () => {
    const { all_Products, CategoryValue, Search_Filter: { categoryFilter, colorFilter, Price, maxPrice, minPrice }, CompanyValue, ColorValue, rangeValue, ClearFilter } = useFilter();
    ...
    let Product_Company = sortoutData(all_Products, "company")
                            ...
                            return (
                                <button type='button'
                                    ...
                                    {curColor === colorFilter ?
                                        <TiTick style={{ color: curColor === '#000000' || curColor === '#000' ? "white" : "black" }} />
                                        : ""}
